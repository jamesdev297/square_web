...
class CustomTooltip extends StatefulWidget {
  ...
  static final List<_CustomTooltipState> _openedTooltips = <_CustomTooltipState>[];
  ...
  static void _concealOtherTooltips(_CustomTooltipState current) {
    if (_openedTooltips.isNotEmpty) {
      // Avoid concurrent modification.
      final List<_CustomTooltipState> openedTooltips = _openedTooltips.toList();
      for (final _CustomTooltipState state in openedTooltips) {
        if (state == current) {
          continue;
        }
...
class _CustomTooltipState extends State<CustomTooltip> with SingleTickerProviderStateMixin {
  ...
  static final Set<_CustomTooltipState> _mouseIn = <_CustomTooltipState>{};
