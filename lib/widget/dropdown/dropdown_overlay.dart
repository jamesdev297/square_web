...
class _DropdownOverlayState extends State<_DropdownOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    // overlay icon
    final overlayIcon = Icon26(Assets.img.ico_26_h_26_ud_gy1);
              ...
              child: DecoratedBox(
                ...
                child: Material(
                  ...
                  child: AnimatedSection(
                    ...
                    child: SizedBox(
                      key: key2,
                      height: items.length > 4 ? onListDataSearch ? 270 : 225 : null,
                      child: ClipRRect(
                        borderRadius: borderRadius,
                          ...
                          child: Theme(
                            data: Theme.of(context).copyWith(
                              scrollbarTheme: ScrollbarThemeData(
                                ...
                                thumbColor: MaterialStateProperty.all(CustomColor.scrollGrey),
                              ),
                            ),
                            child: SizedBox(
                                      ...
                                      child: Row(
                                        children: [
                                          if(headerText.isNotEmpty)
                                            Text(headerText, style: widget.headerStyle, maxLines: 1, overflow: TextOverflow.ellipsis)
                                          else
                                            Text(widget.hintText, style: widget.headerStyle, maxLines: 1, overflow: TextOverflow.ellipsis),
    ...
    return Scrollbar(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, index) {
          ...
          return Container(
            height: Zeplin.size(82),
            decoration: BoxDecoration(
              border: Border(
                top: BorderSide(width: 1, color: CustomColor.dividerGrey),
              ),
            ),
            child: InkWell(
              splashColor: Colors.transparent,
              highlightColor: CustomColor.brightBlue,
              hoverColor: CustomColor.brightBlue,
              onTap: () => onItemSelect(items[index]),
              child: Padding(
                padding: _listItemPadding,
                child: Text(items[index], style: listItemStyle, maxLines: 1, overflow: TextOverflow.ellipsis),
              ),
            ),
          );
        },
